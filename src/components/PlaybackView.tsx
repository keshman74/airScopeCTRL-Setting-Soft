      ...
      <div className="bg-[#111] border border-[#222] rounded-2xl p-8 shadow-2xl">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 w-full space-y-6">
            ...
            {/* Internet Radio (Direct URL & Directory) */}
            <div className="pt-6 border-t border-[#222]">
              <h3 className="text-[10px] font-semibold text-zinc-600 uppercase tracking-widest mb-3">Custom Stream URL</h3>
              <form 
                onSubmit={(e) => {
                  e.preventDefault();
            ...
            <RadioBrowser sendCommand={sendCommand} />
